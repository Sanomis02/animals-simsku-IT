...
$app->get('/sukurti-anketa', \AnketaController::class . ':loadToFormForAdd'); //Control
...
$app->post('/pasalinti-skelbima', \SkelbimasController::class . ':delete');
...
//$app->get('/delete', \SkelbimasController::class . ':delete');
