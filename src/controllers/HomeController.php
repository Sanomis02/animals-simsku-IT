...
class HomeController
{
    ...
    public function home($request, $response, $args)
    {
        try {
	    	...
	    	$this->addData("canPost", $_SESSION["canPost"]);
...
//        var_dump($this->getData());die;
			...
			$this->addData("deleteMessage",$this->getFlashMessage("delete")[0]);
			$this->addData("anketaMessage",$this->getFlashMessage("anketa_failure")[0]);
			$this->addData("skelbimoEditMessage",$this->getFlashMessage("skelbimo_edit_failure")[0]);
